...
//
// Notification service for sending user/system notifications
type NotificationServiceClient interface {
	// Send email
	SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*NotifyResponse, error)
	// Send SMS
	SendSMS(ctx context.Context, in *SendSMSRequest, opts ...grpc.CallOption) (*NotifyResponse, error)
}
...
func (c *notificationServiceClient) SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
...
func (c *notificationServiceClient) SendSMS(ctx context.Context, in *SendSMSRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NotifyResponse)
...
type NotificationServiceServer interface {
	// Send email
	SendEmail(context.Context, *SendEmailRequest) (*NotifyResponse, error)
	// Send SMS
	SendSMS(context.Context, *SendSMSRequest) (*NotifyResponse, error)
...
func (UnimplementedNotificationServiceServer) SendEmail(context.Context, *SendEmailRequest) (*NotifyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendEmail not implemented")
}
func (UnimplementedNotificationServiceServer) SendSMS(context.Context, *SendSMSRequest) (*NotifyResponse, error) {
